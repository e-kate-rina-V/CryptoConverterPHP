    ...
    <div class="profile-info">
        ...
        <section>
            ...
            <?php if (hasValidationError('email')): ?>
                <p id="error-message" class="error-message"><?php echo validationErrorMessage('email'); ?></p>
            <?php endif; ?>
        </section>
                ...
                <div class="change-info">
                    <div id="change-info">
                        ...
                        <?php if (hasValidationError('password')): ?>
                            <p id="error-message" class="error-message"><?php echo validationErrorMessage('password'); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </section>
